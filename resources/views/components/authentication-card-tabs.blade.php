<div class="row mt-3">
    ...
    <div class="col-md-6 my-3">
        <a id="vkButton" href="{{ route('auth.vk') }}" class="btn btn-primary form-control">
            <img src="{{ asset('images/vk.png') }}" alt="{{ __('messages.vk') }}" width="16" height="16"
                 class="me-2 mb-1">{{ __('messages.vk') }}
        </a>
    </div>
    <div class="col-md-6 my-3">
        <a id="yandexButton" href="{{ route('auth.yandex') }}" class="btn btn-primary form-control">
            <img src="{{ asset('images/yandex.png') }}" alt="{{ __('messages.yandex') }}" width="16" height="16"
                 class="me-2 mb-1">{{ __('messages.yandex') }}
        </a>
    </div>
...
@if (Laravel\Jetstream\Jetstream::hasTermsAndPrivacyPolicyFeature())
    <div class="form-check row mx-0 my-2">
        <input type="checkbox" id="agreeTerms" class="form-check col-1"
               style="margin-left: -25px;margin-bottom: -2.675rem;">
