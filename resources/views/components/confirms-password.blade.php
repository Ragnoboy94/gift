@props(['title' => __('app.confirm_password'), 'content' => __('app.confirm_password_text'), 'button' => __('app.confirm')])
...
@once
    <x-dialog-modal wire:model="confirmingPassword">
        ...
        <x-slot name="content">
            {{ __('app.confirm_password_text') }}

            <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
                <x-input type="password" class="mt-1 block w-3/4" placeholder="{{ __('passwords.password') }}" autocomplete="current-password"
