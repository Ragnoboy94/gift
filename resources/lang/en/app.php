...
'disable' => 'Disable',
    ...
    'my_orders'=>'My orders',
    'cod_access'=>'Access code in the mobile application',
    'code_access_text'=>'At the moment, the application is at the testing stage and is not available for download through the platforms.',
    'gift_secrets' => 'Gift secrets',
    'right_my' => 'All rights reserved',
    'hobby_example'=>"He plays sports, likes to read classics",
    'elf_text'=>'Join us and help create unique and unforgettable gifts for people all over Russia. Your talent and creativity will help make every holiday special and unique!',
    'elf_confirm'=>'In order to become an elf, you need to confirm your Email',
    'elf_team_comfirm'=>'Are you sure you want to become an elf and join our team?',
    'elf_yes'=>'Yes, I want to become an elf',
];
