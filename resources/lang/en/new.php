...
return [
    ...
    'problem_text 1'=>'The delivered goods must be confirmed by a receipt and have a marketable appearance. If the product does not meet expectations, this is not a reason for refusing the order and does not exempt from the obligation to pay. In case of non-fulfillment of payment obligations, the contractor has the right to apply to law enforcement agencies. Please be careful and responsible when placing orders.',
    ];
